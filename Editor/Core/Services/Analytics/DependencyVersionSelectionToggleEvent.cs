...
{
    class DependencyVersionSelectionToggleEvent : SettingsToggleEvent
    {
        public DependencyVersionSelectionToggleEvent(bool isToggleOn) : base(isToggleOn)
        {
        }
        ...
        internal class DependencyVersionSelectionToggleEventAnalytic : IAnalytic
        {
            readonly SettingsToggleEventData m_Data;

            public DependencyVersionSelectionToggleEventAnalytic(SettingsToggleEventData data)
            {
                m_Data = data;
            }
        ...
        {
            return new DependencyVersionSelectionToggleEventAnalytic(m_Data);
        }
#endif
    }
}
