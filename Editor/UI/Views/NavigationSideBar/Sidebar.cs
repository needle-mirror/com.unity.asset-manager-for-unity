...
namespace Unity.AssetManager.UI.Editor
{
    class Sidebar : VisualElement
    {
        ...
        public Sidebar(IUnityConnectProxy unityConnectProxy, IStateManager stateManager, IPageManager pageManager, IMessageManager messageManager,
            ...
            IPermissionsManager permissionsManager, TwoPaneSplitView categoriesSplitView, IPopupManager popupManager, SidebarViewModel viewModel)
        {
        ...
        VisualElement CreateSidebar()
        {
            ...
            m_SidebarContent = new SidebarContent(m_ViewModel, m_StateManager, m_MessageManager);
