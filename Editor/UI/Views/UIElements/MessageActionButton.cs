        ...
        public void SetRecommendedAction(RecommendedAction action)
        {
            ...
            switch (action)
            {
                ...
                case RecommendedAction.OpenAssetManagerDocumentationPage:
                {
                    RemoveFromClassList(k_LinkClassName);
                    AddToClassList(k_ButtonClassName);
                    clicked += () => m_LinksProxy.OpenPackageDocumentationPage("upload-assets");
                ...
                case RecommendedAction.OpenUnityCloudConfigurationDocumentation:
                {
                    ...
                    break;
                case RecommendedAction.OpenTrackingFilesMigrationDocumentation:
                {
                    RemoveFromClassList(k_LinkClassName);
                    AddToClassList(k_ButtonClassName);
                    clicked += () => m_LinksProxy.OpenPackageDocumentationPage("tracking-files");
