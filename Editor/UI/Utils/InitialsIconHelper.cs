...
{
    static class InitialsIconHelper
    {
        // Based on same color palette used by AM Dashboard
        ...
        public static Color GetUserColor(string userId)
        {
        ...
        public static VisualElement CreateInitialsIcon(string name, string userId)
        {
            var initialsCircle = new VisualElement();
            initialsCircle.name = "InitialsCircle";
            initialsCircle.style.backgroundColor = GetUserColor(userId);
            initialsCircle.pickingMode = PickingMode.Ignore;

            var initials = new Label();
            initials.name = "Initials";
            initials.text = Utilities.GetInitials(name);
