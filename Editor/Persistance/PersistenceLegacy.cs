...
namespace Unity.AssetManager.Editor
{
    ...
    class AssetDataPersistenceLegacy
    {
        ...
        [SerializeReference]
        public List<AssetDataPersistenceLegacy> m_Versions = new();
    }
    ...
    class PersistenceLegacy
    {
        ...
        DependencyAsset Convert(DependencyAssetPersistenceLegacy persistedLegacy)
        {
            if (persistedLegacy == null)
            {
                return null;
            ...
            if (m_DependencyAssets.TryGetValue(persistedLegacy, out var dependencyAsset))
            {
                return dependencyAsset;
            }

            dependencyAsset = new DependencyAsset(
                persistedLegacy.m_Identifier,
                Convert(persistedLegacy.m_AssetData));

            m_DependencyAssets[persistedLegacy] = dependencyAsset;
